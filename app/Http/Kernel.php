...
class Kernel extends HttpKernel
{
     ...
     *
     * These middleware can be assigned to groups for easier assignment.
     *
     * @var array
     */
    ...
    protected $routeMiddleware = [
        ...
        'role' => \Spatie\Permission\Middlewares\RoleMiddleware::class, // Si tu utilises le middleware de rôles
    ];
}
